...
class ERC20Client:
    ...
    async def approve(self, account: Account, spender: ContractAddress, amount: int, max_fee: int, nonce=None,
                      send_to_chain=True):
    ...
    async def increase_allowance(self, account: Account, spender: ContractAddress, added_amount: int, max_fee: int,
                                 nonce=None,
                                 send_to_chain=True):
